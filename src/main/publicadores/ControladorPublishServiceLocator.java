...
public class ControladorPublishServiceLocator extends org.apache.axis.client.Service implements main.publicadores.ControladorPublishService {
    ...
    public main.publicadores.ControladorPublish getControladorPublishPort() throws javax.xml.rpc.ServiceException {
    ...
    public main.publicadores.ControladorPublish getControladorPublishPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.publicadores.ControladorPublishPortBindingStub _stub = new main.publicadores.ControladorPublishPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.publicadores.ControladorPublish.class.isAssignableFrom(serviceEndpointInterface)) {
                main.publicadores.ControladorPublishPortBindingStub _stub = new main.publicadores.ControladorPublishPortBindingStub(new java.net.URL(ControladorPublishPort_address), this);
                _stub.setPortName(getControladorPublishPortWSDDServiceName());
                return _stub;
            }
        }
